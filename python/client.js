    ...
    (function(){
                        ...
                        if (exist(record)) {
                            ρσ_interpolate_kwargs.call(self, self.browse, [ρσ_desugar_kwargs({ids: ids, is_client: false})]).then((function() {
                                var ρσ_anonfunc = function (records) {
                                    ...
                                    if (exist(records)) {
                                        var ρσ_Iter9 = ρσ_Iterable(records);
                                        for (var ρσ_Index9 = 0; ρσ_Index9 < ρσ_Iter9.length; ρσ_Index9++) {
                                            record = ρσ_Iter9[ρσ_Index9];
                                            values = {};
                                            if (!records._is_singleton) {
                                                result.values = ρσ_list_decorate([ result.values ]);
                                            }
                                            var ρσ_Iter10 = ρσ_Iterable(result.values);
                                            for (var ρσ_Index10 = 0; ρσ_Index10 < ρσ_Iter10.length; ρσ_Index10++) {
                                                value = ρσ_Iter10[ρσ_Index10];
                                        ...
                                        var ρσ_Iter11 = ρσ_Iterable(result.values);
                                        for (var ρσ_Index11 = 0; ρσ_Index11 < ρσ_Iter11.length; ρσ_Index11++) {
                                            value = ρσ_Iter11[ρσ_Index11];
                                            delete value.rev;
                                            delete value._rev;
                                            delete value._id;
        ...
        Model.prototype.search = function search() {
            ...
            if (exist(options.is_client)) {
                ...
                return ajax("post", "json", configuration.url + "/api/search", (function(){
                    ...
                    var ρσ_anonfunc = function (result) {
                        ...
                        var ρσ_Iter12 = ρσ_Iterable(record.ids);
            ...
            function query(record) {
                ...
                var ρσ_Iter13 = ρσ_Iterable(args);
                ...
                return db.rel.find(result._name).then((function() {
                    var ρσ_anonfunc = function (records) {
                        ...
                        if (exist(options.order)) {
                            var ρσ_Iter14 = ρσ_Iterable(options.order.split(","));
                            for (var ρσ_Index14 = 0; ρσ_Index14 < ρσ_Iter14.length; ρσ_Index14++) {
                                order = ρσ_Iter14[ρσ_Index14];
                ...
                return db.rel.find(result._name).then((function() {
                    var ρσ_anonfunc = function (records) {
                        ...
                        if (records[ρσ_bound_index(result._name, records)].length > 1) {
                            ...
                            if (exist(options.order)) {
                                var ρσ_Iter15 = ρσ_Iterable(options.order.split(","));
                                for (var ρσ_Index15 = 0; ρσ_Index15 < ρσ_Iter15.length; ρσ_Index15++) {
                                    order = ρσ_Iter15[ρσ_Index15];
                                    ρσ_unpack = order.split(" ");
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
                                    order = ρσ_unpack[0];
                                    desc = ρσ_unpack[1];
...
ρσ_unpack = ρσ_unpack_asarray(2, ρσ_unpack);
        ...
        Model.prototype.adapt = function adapt(key, value) {
            ...
            if (ρσ_in((ρσ_expr_temp = self._fields)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key].store, ρσ_list_decorate([ true, null ]))) {
                ...
                if (exist((ρσ_expr_temp = self._related)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key])) {
                    var ρσ_Iter17 = ρσ_Iterable((ρσ_expr_temp = self._related)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key]);
                    for (var ρσ_Index17 = 0; ρσ_Index17 < ρσ_Iter17.length; ρσ_Index17++) {
                        field = ρσ_Iter17[ρσ_Index17];
        ...
        Model.prototype.update = function update() {
            ...
            var ρσ_Iter18 = ρσ_Iterable(values);
            for (var ρσ_Index18 = 0; ρσ_Index18 < ρσ_Iter18.length; ρσ_Index18++) {
                ...
                if (self._is_singleton) {
                    ...
                    var ρσ_Iter19 = ρσ_Iterable(self._values);
                    for (var ρσ_Index19 = 0; ρσ_Index19 < ρσ_Iter19.length; ρσ_Index19++) {
                        object = ρσ_Iter19[ρσ_Index19];
        ...
        Model.prototype.unlink = function unlink() {
            ...
            if (self._is_singleton) {
                ...
                var ρσ_Iter20 = ρσ_Iterable(self._values);
                for (var ρσ_Index20 = 0; ρσ_Index20 < ρσ_Iter20.length; ρσ_Index20++) {
                    value = ρσ_Iter20[ρσ_Index20];
                    value["_deleted"] = true;
                }
...
return this.__repr__();
    ...
    (function(){
        ...
        tools.configuration.home_view = window.localStorage.rapyd_home_view || "res.message.chat";
        configuration = {"home_view": window.localStorage.rapyd_home_view || "res.message.chat"};
        configuration.client = tools.configuration.client;
        tools.configuration = Object.assign(tools.configuration, configuration);
        var ρσ_Iter0 = ρσ_Iterable(tools.menu);
        for (var ρσ_Index0 = 0; ρσ_Index0 < ρσ_Iter0.length; ρσ_Index0++) {
            key = ρσ_Iter0[ρσ_Index0];
            if (tools.exist((ρσ_expr_temp = tools.menu)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key].parent)) {
                if (ρσ_in((ρσ_expr_temp = tools.menu)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key].parent, tools.menu)) {
                    (ρσ_expr_temp = tools.menu)[ρσ_bound_index((ρσ_expr_temp = tools.menu)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key].parent, ρσ_expr_temp)].childs.push((ρσ_expr_temp = tools.menu)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key]);
                    (ρσ_expr_temp = tools.menu)[ρσ_bound_index((ρσ_expr_temp = tools.menu)[(typeof key === "number" && key < 0) ? ρσ_expr_temp.length + key : key].parent, ρσ_expr_temp)].childs.sort((function() {
                        var ρσ_anonfunc = function (a, b) {
